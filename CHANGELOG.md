...
- Multiline text editor popup (`F2` on an active field) for editing long values, with its own cursor and insert/delete/line-navigation, no new dependency added.
